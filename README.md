...
O projeto consistiu em processar e analisar dois conjuntos de dados (`pedidos.csv` e `cardapio`) para gerar insights sobre faturamento, comportamento de compra e saúde financeira do negócio.
...
* **Receita Total:** [Insira o valor aqui]
* **Ticket Médio:** [Insira o valor aqui]
* **Top Categoria:** [Insira a categoria que mais faturou]
